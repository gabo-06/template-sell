...
$(function () {
    ...
    $(document).on('click', '[data-toggle="lightbox"]', function (event) {
        ...
        $(this).ekkoLightbox({
            ...
            leftArrow: '<span><img src="' + basePath + 'img/prev.3bd24274.svg" class="nav-arrow nav-arrow-left" alt="" width="50"></span>',
            rightArrow: '<span><img src="' + basePath + 'img/next.ef15fe32.svg" class="nav-arrow nav-arrow-right" alt="" width="50"></span>'
        });
    });
    ...
    if ($('#map').length > 0) {
        ...
        function initMap() {
            ...
            var markerImage = basePath + 'img/marker.db74de37.png';
